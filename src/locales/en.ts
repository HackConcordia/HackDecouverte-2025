export const en = {
  ...
  aboutUs: {
    ...
    hackathon: {
      ...
      answer:
        "A hackathon is an event where individuals come together to collaborate on software or hardware projects, often within a specific timeframe.",
    },
    hackDecouverte: {
      question: "What is HackDécouverte?",
      answer:
        "HackDécouverte is a bilingual, beginner-friendly hackathon for pre-university students across Québec.",
    },
    hackConcordia: {
